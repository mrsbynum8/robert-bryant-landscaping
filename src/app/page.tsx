    ...
    <div className="flex min-h-screen flex-col bg-background font-sans">
      ...
      */}
      ...
      {/* 
        ABOUT SECTION 
      */}
      <section id="about" className="pt-12 pb-24 md:py-24 bg-white overflow-hidden">
      ...
      {/* 
        SERVICES SECTION
      */}
      <section id="services" className="relative bg-muted pt-12 pb-24 md:py-24 overflow-hidden">
        {/* Background Pattern */}
